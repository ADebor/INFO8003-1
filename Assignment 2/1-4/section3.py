...
def create_gif(trajectory):
    """
    Create a gif representing the evolution of the agent in the domain 
    Warning: A folder called "images" needs to be created in the project
    directory

    Parameters
    ----------
    trajectory : A sequence of tuples representing the trajectory
...
if __name__ == "__main__":
    ...
    trajectory = agent.domain_exploration(800)
    
    create_gif(trajectory)
